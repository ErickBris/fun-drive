...
<?php 
	...
	require_once("thumbnail_images.class.php");  
 	 	...
 	 	if(isset($_GET['cid']))
	{
 			$qry="SELECT * FROM video_category WHERE cid='".$_GET['cid']."'";
		  ...
		  if(isset($_POST['submit']))
			{
				...
				$img_res=mysql_query('SELECT * FROM video_category WHERE cid=\''.$_GET['cid'].'\'');
				   ...
				   $pic1=$_FILES['category_image']['tmp_name'];
					 ...
					 $tpath1='upload/'.$category_image;
							 ...
							 copy($pic1,$tpath1);
								   ...
								   $category_edit=Update('video_category', $data, "WHERE cid = '".$_POST['cid']."'");
								   }
									else
								   {
														 $data = array(											 
			           ...
			           $category_edit=Update('video_category', $data, "WHERE cid = '".$_POST['cid']."'");
					    ...
					    if ($category_edit > 0){
 						...
 						$_SESSION['msg']="11";
						header( "Location:edit_video_category.php?cid=".$_POST['cid']);
						exit;
						}
 		}
 ?>
