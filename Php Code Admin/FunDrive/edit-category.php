...
<?php 
	...
	require_once("thumbnail_images.class.php");  
 	 	...
 	 	if(isset($_GET['cid']))
	{
 			$qry="SELECT * FROM wallpaper_categories WHERE cid='".$_GET['cid']."'";
		  ...
		  if(isset($_POST['submit']))
			{
				...
				$img_res=mysql_query('SELECT * FROM wallpaper_categories WHERE cid=\''.$_GET['cid'].'\'');
				   ...
				   $pic1=$_FILES['category_image']['tmp_name'];
					 ...
					 $tpath1='upload/'.$category_image;
							 ...
							 copy($pic1,$tpath1);
								   ...
								   $category_edit=Update('wallpaper_categories', $data, "WHERE cid = '".$_POST['cid']."'");
								   }
									else
								   {
														 $data = array(											 
