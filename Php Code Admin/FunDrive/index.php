...
<?php $filename = 'includes/db_connection.php';
...
<div id="login-holder">
	...
	<div id="loginbox">
     ...
     <p style="color:#990000; font-size:14px; padding-bottom:5px">
	...
	<form action="login_db.php" method="post" enctype="multipart/form-data" >
      ...
      <label>Password</label>
			...
			<input type="password" value="" name="password" id="password"   class="login-inp" />
 ...
 <!--  end loginbox -->
  ...
  <!--  start forgotbox ................................................................................... -->
    ...
    <h3 style="color:#FFF">Design By <a style="color:#FFF" target="_blank" href="http://www.viaviweb.com/">Viaviweb</a></h3>
