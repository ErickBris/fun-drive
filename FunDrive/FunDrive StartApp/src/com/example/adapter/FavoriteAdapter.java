...
public class FavoriteAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		vi=inflate.inflate(R.layout.walllatestgrid_item, null);
		...
		item.img_fav.setScaleType(ImageView.ScaleType.CENTER_CROP);
		 item.img_fav.setLayoutParams(new GridView.LayoutParams(imageWidth,
					imageWidth));
		imageLoader.DisplayImage(Constant.SERVER_IMAGE_UPFOLDER_CATEGORY+data.get(position).getImageurl().toString(), item.img_fav);
